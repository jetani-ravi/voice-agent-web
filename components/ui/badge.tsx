  ...
  "inline-flex items-center gap-1.5 rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        "subtle-secondary": "border-transparent bg-secondary/20 text-secondary-foreground hover:bg-secondary/30",
        "subtle-destructive": "border-transparent bg-destructive/20 text-destructive hover:bg-destructive/30",
        "subtle-success": "border-transparent bg-success/20 text-success hover:bg-success/30",
        "subtle-warning": "border-transparent bg-warning/20 text-warning hover:bg-warning/30",
        "subtle-info": "border-transparent bg-info/20 text-info hover:bg-info/30",
      },
      size: {
