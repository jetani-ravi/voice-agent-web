  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex h-full w-(--sidebar-width) flex-col bg-sidebar text-sidebar-foreground shadow-xs",
            className
          )}
          ref={ref}
          {...props}
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-(--sidebar-width) bg-sidebar p-0 text-sidebar-foreground shadow-md [&>button]:hidden"
            style={
              {
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-3 overflow-auto group-data-[collapsible=icon]:overflow-hidden group-data-[collapsible=icon]:items-center",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <li
    ...
    className={cn(
      "group/menu-item relative has-data-[active=true]:before:absolute has-data-[active=true]:before:left-0 has-data-[active=true]:before:top-1/2 has-data-[active=true]:before:h-6 has-data-[active=true]:before:w-0.5 has-data-[active=true]:before:-translate-y-1/2 has-data-[active=true]:before:rounded-r has-data-[active=true]:before:bg-sidebar-primary",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    className={cn(
      "mx-3 flex min-w-0 translate-x-px flex-col gap-1 border-l border-sidebar-border pl-3 pr-1 py-1.5",
      "group-data-[collapsible=icon]:hidden",
      className
    )}
    {...props}
...
>(({ asChild = false, size = "md", isActive, className, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "flex h-9 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-3 text-sidebar-foreground outline-hidden ring-sidebar-ring transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-accent-foreground",
